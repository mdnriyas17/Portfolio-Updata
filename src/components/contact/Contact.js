            ...
            <div className="col-sm-12 col-md-6 contact-left-container">
              ...
              <div>
                <div className="contact-icon">
                  ...
                  <p 
                    onClick={() =>
                      window.open("https://github.com/mdnriyas17", "_blank")
                    }
                  >
                  ...
                  <p
                    onClick={() =>
                      window.open(
                        "https://www.linkedin.com/in/mdnriyas/",
                        "_blank"
                      )
                    }
                  >
                  ...
                  <p
                    onClick={() => window.open("tel://+918531803391", "_blank")}
                  >
                    <CallIcon fontSize="medium" /> +91 8531803391
                  </p>
                  <p className="ss"
                    onClick={() =>
                      window.open("mailto:mdnriyas@gmail.com", "_blank")
                    }
                  >
                    <MailIcon fontSize="medium" /> mdnriyas@gmail.com
                  </p>
                </div>
                <div>
                  <img
